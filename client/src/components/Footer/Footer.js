        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box mt-5 mx-auto">
              <i class="fa fa-4x fa-diamond text-danger mb-3 sr-icons"></i>
              <h3 class="mb-3 text-faded">Section One</h3>
              <p class="text-light mb-0 text-light">Text Goes Here...Text Goes Here...Text Goes Here...Text Goes Here...</p>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box mt-5 mx-auto">
          ...
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box mt-5 mx-auto">
              <i class="fa fa-4x fa-heart text-secondary mb-3 sr-icons"></i>
